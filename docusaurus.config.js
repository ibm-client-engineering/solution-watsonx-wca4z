  ...
  const config = {
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              "https://github.com/ibm-client-engineering/solution-watsonx-ca4z/tree/main/packages/create-docusaurus/templates/shared/",
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              "https://github.com/ibm-client-engineering/solution-watsonx-ca4z/edit/main/${blogDirPath}/${blogPath}",
    ...
    themeConfig:
      ...
      ({
        ...
        navbar: {
          title: "| IBM Solution Watsonx Code Assistant for Z",
          logo: {
            alt: "My Site Logo",
            src: "img/logo.svg",
          ...
          items: [
            ...
            {
              href: "https://github.com/ibm-client-engineering/solution-watsonx-ca4z",
