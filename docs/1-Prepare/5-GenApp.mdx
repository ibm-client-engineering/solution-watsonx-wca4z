...
- FQDN + port - should be retrieved from the returned JSON from [here](/Prepare/cloud_databases#creating-the-service-credentials). Our example cloud db2 url is `<DB2_HOSTNAME>:31106`
...
DBServerName = "BLUDB [<DB2_HOSTNAME>:31106]"
DBName = "BLUDB"
AttachToDB = "Y"
EnableCross = "N"
```
