...
```json
{
  ...
  "connection": {
    "cli": {
      ...
      "bin": "db2",
      "certificate": {
        "certificate_base64": "<YOUR_CERTIFICATE_BASE64_CONTENT>",
        "name": "f64c7886-a9cf-45d4-8c62-2a5d468cb8d2"
      },
      "composed": [
        "db2 -u <DB2_USERNAME> -p <DB2_PASSWORD> --ssl --sslCAFile f64c7886-a9cf-45d4-8c62-2a5d468cb8d2 --authenticationDatabase admin --host <DB2_HOSTNAME>:31106"
      ],
      "environment": {},
      "type": "cli"
    },
    "db2": {
      ...
      "composed": [
        "db2://<DB2_USERNAME>:<DB2_PASSWORD>@<DB2_HOSTNAME>:31106/bludb?authSource=admin&replicaSet=replset"
      ],
      "database": "bludb",
      "host_ros": [
        "<DB2_HOSTNAME>:31858"
      ...
      "jdbc_url": [
        "jdbc:db2://<DB2_HOSTNAME>:31106/bludb:user=<userid>;password=<your_password>;sslConnection=true;"
      ],
      "path": "/bludb",
      "query_options": {
        "authSource": "admin",
  ...
  "iam_apikey_description": "Auto-generated for key crn:v1:bluemix:public:dashdb-for-transactions:us-south:a/<IBM_CLOUD_ACCOUNT_ID>:dbd5d8b8-61c3-49dc-9213-79a4104c27f6:resource-key:<DB2_USERNAME>-d65a-4381-afe1-c92d03288fce",
  "iam_apikey_id": "<IAM_API_KEY>",
  "iam_apikey_name": "db2_sa",
  "iam_role_crn": "crn:v1:bluemix:public:iam::::serviceRole:Manager",
  "iam_serviceid_crn": "crn:v1:bluemix:public:iam-identity::a/<IBM_CLOUD_ACCOUNT_ID>::serviceid:ServiceId-719a6cfa-ec45-4ff1-8970-e2208ad69d0d",
  "instance_administration_api": {
    "deployment_id": "crn:v1:bluemix:public:dashdb-for-transactions:us-south:a/<IBM_CLOUD_ACCOUNT_ID>:dbd5d8b8-61c3-49dc-9213-79a4104c27f6::",
    "instance_id": "crn:v1:bluemix:public:dashdb-for-transactions:us-south:a/<IBM_CLOUD_ACCOUNT_ID>:dbd5d8b8-61c3-49dc-9213-79a4104c27f6::",
...
- Service Account Username: `<DB2_USERNAME>`
- Service Account Password: `<DB2_PASSWORD>`
- FQDN + Port: `<DB2_HOSTNAME>:31106`
...
From the above image our example FQDN for DB2 is `<DB2_HOSTNAME>` and our port is `31106`.
...
```powershell
db2cli writecfg add -database bludb -host <DB2_HOSTNAME> -port 31106
db2cli writecfg add -dsn dashdb -database bludb -host <DB2_HOSTNAME> -port 31106
db2cli writecfg add -database bludb -host <DB2_HOSTNAME> -port 31106 -parameter "SecurityTransportMode=SSL"
```
...
- Service Account Username (retrieved above): `<DB2_USERNAME>`
- Service Account Password (retrieved above): `<DB2_PASSWORD>`
- Port: `31106`


```powershell
PS D:\> .\db2configuration.bat dbName=BLUDB db2Host=3b84375f-36fb-42b0-8241-ac0e7840e5dc.bpe60pbd01oinge4psd0.databases.appdomain.cloud db2Port=31838 db2User=<DB2_USERNAME> db2Password=<DB2_PASSWORD> useTLS=true
