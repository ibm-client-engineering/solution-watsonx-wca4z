...
The API key will be generated as well as a password. Take note of these values from the JSON.
...
- Service Account API Key: `VHKChdvb_AzpSEQPjK7foePL41UJgr13ACQzRRHU03te`
